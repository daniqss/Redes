...
public class BadRequestController implements HttpController {

    @Override
    public HttpResponse get(HttpRequest request) {
        HttpResponse response = new HttpResponse(request, 400, "text/html");
        ArrayList<Byte> body = readFileBytes("p1-files/error400.html");
    ...
    public HttpResponse head(HttpRequest request) {
        return new HttpResponse(request, 400, "text/html");
    }
